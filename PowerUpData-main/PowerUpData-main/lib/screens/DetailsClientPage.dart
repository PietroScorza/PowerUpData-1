...
class DetailsClient extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: const Color.fromARGB(255, 177, 129, 114),
      appBar: AppBar(
        centerTitle: true,
        ...
        child: Container(
            ...
            child: Column(
              children: [
                ...
                Text("Quedan ${client.diasRestantes()} dias",
                    style: MyTextStyle(
                        color: Colors.black,
                        context,
                        16,
                ...
                Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                  Text("Ultima de matriculación: ",
                      style: MyTextStyle(context, 12,
                          color: Colors.black, fontWeight: FontWeight.bold)),
                  Text(client.getFechaMatricula(),
                      style: MyTextStyle(context, 12,
                          color: Colors.black, fontWeight: FontWeight.bold))
                ]),
                const Padding(padding: EdgeInsets.all(8)),
